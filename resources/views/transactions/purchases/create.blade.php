...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Add Stock / New Purchase</h1>
            <p class="mb-0">Select a product to record a purchase.</p>
        </div>
    ...
    <div class="row">
        @forelse($products as $p)
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                <div class="card shadow-sm h-100 product-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="fw-bold text-info mb-3">
                            Buying Price: KES {{ number_format($p->cost_price, 2) }}
                        </p>

                        <!-- Purchase Button -->
                        <button class="btn btn-info mt-auto" data-bs-toggle="modal"
                                data-bs-target="#purchaseModal{{ $p->id }}">
            ...
            <!-- Purchase Modal -->
            <div class="modal fade" id="purchaseModal{{ $p->id }}" tabindex="-1" aria-labelledby="purchaseModalLabel{{ $p->id }}" aria-hidden="true">
                    ...
                    <form method="post" action="{{ route('purchases.store') }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="purchaseModalLabel{{ $p->id }}">Purchase {{ $p->name }}</h5>
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-info text-center">
                    <i class="fas fa-info-circle me-1"></i> No products available for purchase.
                </div>
            </div>
        @endforelse
    </div>
...
<style>
    ...
    /* Pagination styling to match card theme */
