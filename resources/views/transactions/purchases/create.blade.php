...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3"><i class="fas fa-cart-plus text-primary"></i> New Stock In</h1>
...
<div class="row">
    ...
    <p class="fw-bold text-info mb-2">
        ...
        {{ number_format($p->cost_price, 2) }} TZS
    </p>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                <i class="fas fa-cart-plus text-primary"></i> Purchase {{ $p->name }}
                            </h5>
